<template>
  <div class="flashcard-container">
    ...
    <div v-if="showAnswer" class="rating-buttons">
      <el-button class="rate-btn rate-again" @click="$emit('rate', 1)" :loading="submitting">再来一遍</el-button>
      <el-button class="rate-btn rate-hard" @click="$emit('rate', 2)" :loading="submitting">有点难</el-button>
      <el-button class="rate-btn rate-good" @click="$emit('rate', 3)" :loading="submitting">认识</el-button>
      <el-button class="rate-btn rate-easy" @click="$emit('rate', 4)" :loading="submitting">很熟悉</el-button>
    </div>
