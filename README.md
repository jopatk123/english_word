...
- AI 辅助：词根建议、单词建议、例句建议、单词分析、句子分析、例句点词查义、模型自动发现、思考模型自动禁用思考
- 例句点词查义：详情、闪卡、自动朗读和搜索结果中的英文句子可点击单词，先查个人词库，未收录时给出短释义并缓存，可加入「未分类」词库或打开完整分析
...
- 手机端：窄屏使用底部主导航和学习会话全屏，列表改为卡片或横向滚动，支持添加到主屏
